...
public abstract class ArgumentSorterNode extends BaseNode {
  ...
  public Object invokeCached(
    ...
    return mappingNode.execute(function, stateRef, arguments, optimiser);
  }
  ...
  public Object invokeUncached(Function function, StateRef stateRef, Object[] arguments) {
    return invokeCached(
        function,
        stateRef,
        arguments,
   ...
   */
  public abstract Object execute(Function callable, StateRef stateRef, Object[] arguments);
